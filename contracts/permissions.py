...
class ContractPermissions(permissions.BasePermission):
    """
        ...
        sur les objets Contract en fonction du rôle de l'utilisateur connecté.
        ...
        Méthode has_permission:
            ...
            - Pour les autres méthodes (POST, PUT, DELETE),
              vérifie si l'utilisateur connecté est le gestionnaire du contrat ou membre de l'équipe de gestion.
        ...
        avec des autorisations spécifiques pour l'équipe de gestion et l'équipe commerciale.
    """
    ...
    def has_permission(self, request, view):
        try:
            ...
            # Vérifie si l'utilisateur connecté est le gestionnaire du contrat
            # ou membre de l'équipe gestion ou commerciale
            return request.user.role in [User.ROLE_MANAGEMENT, User.ROLE_SALES]
