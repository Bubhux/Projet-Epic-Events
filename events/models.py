...
class Event(models.Model):
    ...
    contract = models.ForeignKey(
        Contract,
        on_delete=models.SET_NULL, null=True, blank=True, related_name='contract_events', verbose_name="Contract"
    )

    client = models.ForeignKey(
        Client,
        on_delete=models.SET_NULL, null=True, blank=True, related_name='client_events', verbose_name="Client"
    )
    ...
    support_contact = models.ForeignKey(
        ...
        verbose_name="Support Contact", limit_choices_to={'role': User.ROLE_SUPPORT}
    )
